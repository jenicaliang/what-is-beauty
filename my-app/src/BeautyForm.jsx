...
export default function BeautyForm() {
  ...
  // NEW: controls whether the form is revealed
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const SCRIPT_URL =
        "https://script.google.com/macros/s/AKfycbzX1vvUVWigP4Sma9YK6stELtiohbZvFlYcR_j76UX-oVH45-fQkqsbqsbhSm6gqjA-/exec";
  ...
  return (
    <section className="beauty-form-section">
      ...
      {/* Only show form AFTER clicking the button */}
      {showForm && (
        <div className="beauty-form-container fade-in">
